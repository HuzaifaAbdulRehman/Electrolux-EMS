...
export default function TariffManagement() {
  ...
  const currentTariff = tariffStructure[selectedCategory as keyof typeof tariffStructure];
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">Tariff Management</h1>
              <p className="text-gray-400">Configure electricity rates and pricing structures</p>
            </div>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className={`relative flex items-center space-x-3 px-6 py-3 bg-white/5 backdrop-blur-sm rounded-xl border ${
                selectedCategory === category.id ? 'border-yellow-400/50 bg-white/10' : 'border-white/10'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-white">Basic Charges</h2>
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
              <div>
                <p className="text-gray-400 text-sm">Fixed Monthly Charge</p>
                <p className="text-3xl font-bold text-white">${currentTariff.fixedCharge}</p>
              </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-white">Slab Rates</h2>
            </div>
                ...
                <div key={index} className="flex items-center justify-between p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Consumption Range</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-2xl font-bold text-white">${slab.rate}</p>
          ...
          {/* Time of Use Rates */}
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
            <h2 className="text-xl font-bold text-white mb-4">Time of Use Rates</h2>
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-red-500/10 to-rose-500/10 rounded-xl border border-red-500/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{currentTariff.timeOfUse.peak.hours}</p>
                  </div>
                </div>
                <p className="text-xl font-bold text-white">${currentTariff.timeOfUse.peak.rate}/kWh</p>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{currentTariff.timeOfUse.normal.hours}</p>
                  </div>
                </div>
                <p className="text-xl font-bold text-white">${currentTariff.timeOfUse.normal.rate}/kWh</p>
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl border border-green-500/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{currentTariff.timeOfUse.offPeak.hours}</p>
                  </div>
                </div>
                <p className="text-xl font-bold text-white">${currentTariff.timeOfUse.offPeak.rate}/kWh</p>
              </div>
            </div>
          </div>
        </div>
