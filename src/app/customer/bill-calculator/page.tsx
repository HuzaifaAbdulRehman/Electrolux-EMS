          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2 flex items-center">
                <Calculator className="w-8 h-8 mr-3 text-yellow-500" />
                Bill Calculator
              </h1>
              <p className="text-gray-600 dark:text-gray-400">
                Calculate your electricity bill with accurate tariff rates and taxes
              </p>
            </div>
            <button
            ...
            {calculated && unitsConsumed > 0 ? (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-gradient-to-r from-yellow-400/10 to-orange-500/10 rounded-xl border border-yellow-500/20">
                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Units Consumed</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">{unitsConsumed}</p>
                ...
                <div className="flex space-x-4 mt-6">
                  <button className="flex-1 px-4 py-3 bg-gray-100 dark:bg-white/10 text-gray-700 dark:text-white rounded-lg hover:bg-gray-200 dark:hover:bg-white/20 transition-all flex items-center justify-center space-x-2">
                    <Download className="w-5 h-5" />
                    <span>Download PDF</span>
                  </button>
                  <button className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center justify-center space-x-2">
              ...
              <div className="flex flex-col items-center justify-center h-96 text-center">
                <div className="w-20 h-20 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-sm">
                  Enter your connection type and units consumed to get an accurate bill estimate with all taxes and charges
                </p>
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-xl rounded-xl p-6 border border-blue-500/20">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Bills are calculated using slab-based tariff rates. Lower slabs have lower rates, encouraging energy conservation.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 backdrop-blur-xl rounded-xl p-6 border border-green-500/20">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Save Money</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Reduce consumption to stay in lower slabs. Every unit saved means more savings on your bill!
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-xl rounded-xl p-6 border border-purple-500/20">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Accurate Estimates</h3>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Our calculator uses official tariff rates and includes all applicable taxes and duties.
            </p>
          </div>
        </div>
      </div>
