  ...
  const notifications = [
    {
      ...
      message: 'Your October 2024 electricity bill of Rs 24,550 is now available',
      time: '2 hours ago',
      date: '2024-10-10',
      read: false,
      priority: 'high',
    ...
    },
    {
      ...
      message: 'Payment of Rs 22,000 has been successfully processed',
      time: '1 day ago',
      date: '2024-10-09',
      read: true,
      priority: 'normal',
    ...
    },
    {
      ...
      message: 'Your bill payment is due in 3 days. Amount: Rs 24,550',
      time: '1 week ago',
      date: '2024-10-03',
      read: false,
      priority: 'high',
