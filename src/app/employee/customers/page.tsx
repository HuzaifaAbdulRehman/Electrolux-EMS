        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <select
              ...
              className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-yellow-400"
            >
            ...
            <table className="w-full">
              <thead className="bg-white/5 border-b border-white/10">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-medium text-gray-400 uppercase">Meter Info</th>
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-300 text-sm">{customer.address}</span>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <p className="text-gray-400 text-sm mt-1">Reading: {customer.lastReading} kWh</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div>
                        <p className="text-white font-semibold">{customer.avgConsumption} kWh/mo</p>
                        <p className="text-gray-400 text-sm">Last Bill: ${customer.lastBill}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
