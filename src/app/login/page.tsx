            ...
            <div className="space-y-2">
              {[
                ...
                <div key={index} className="flex items-start space-x-3">
                  <div className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center text-yellow-400 flex-shrink-0">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
              ...
              <div className="flex items-center justify-center space-x-3 mb-4">
                <button className="flex-1 py-2.5 px-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white hover:bg-white/20 transition-all duration-300 flex items-center justify-center space-x-2">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 bg-white/10 border border-white/20 rounded text-yellow-400 focus:ring-yellow-400 focus:ring-offset-0"
                      disabled={isLoading}
                    />
              ...
              <div className="mt-4 p-3 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-xs text-gray-300">Secure Connection</p>
