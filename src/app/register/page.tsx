      ...
      <div className="container mx-auto max-w-6xl relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="hidden lg:block space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-white">Why Register?</h3>
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Confirm Password */}
                  <div>
                    <label className="text-xs text-gray-300 mb-1 block">Confirm Password *</label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                      <input
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Meter Number */}
                  <div>
                    <label className="text-xs text-gray-300 mb-1 block">Meter Number *</label>
                    <div className="relative">
                ...
                {/* Full Address */}
                <div>
                  <label className="text-xs text-gray-300 mb-1 block">Full Address *</label>
                  <div className="relative">
                    <MapPin className="absolute left-3 top-3 w-4 h-4 text-gray-400" />
                    <textarea
                      value={formData.fullAddress}
                      onChange={(e) => setFormData({ ...formData, fullAddress: e.target.value })}
                      className="w-full pl-10 pr-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm placeholder-gray-400 focus:outline-none focus:border-yellow-400 transition-colors resize-none"
                ...
                <div>
                  <label className="flex items-start space-x-2 cursor-pointer">
                    <input
                      ...
                      className="mt-0.5 w-4 h-4 bg-white/10 border border-white/20 rounded text-yellow-400 focus:ring-yellow-400 focus:ring-offset-0"
                    />
